...
library AddressBook {
    ...
    address constant internal TuringCreditBobaBeam = 0x4200000000000000000000000000000000000020;
    ...
    address constant internal TuringHelperBobaBeam = 0x3e9694a37846C864C67253af6F5d1F534ff3BF46;
    ...
    function turingCredit() internal view returns (address) {
        ...
        if (block.chainid == 1_294) return TuringCreditBobaBeam;
    ...
    function turingHelper() internal view returns (address) {
        ...
        if (block.chainid == 1_294) return TuringHelperBobaBeam;
